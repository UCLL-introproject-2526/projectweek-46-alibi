...
>>>>>>> 4ba0413174286c39f33e030f2db7c478dd1a738d
...
<<<<<<< HEAD
    ...
    score_timer = 0
    spawn_timer = 0
    spawn_delay = 90  # iets sneller spawn → meer uitdaging
    shark_speed = 5    # iets sneller
    game_over = False
=======
    spawn_timer = 0
    spawn_delay = 120
...
<<<<<<< HEAD
        if not game_over:
            ...
            if score % 10 == 0 and score != 0:
                shark_speed += 0.1      # haaien sneller
                spawn_delay = max(60, spawn_delay - 2)  # vaker haaien
